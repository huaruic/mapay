...
| **Passport (Monad testnet)** | [`0x6d1a5fba0CBbB49878CdF333AA4A7de169bd45A4`](https://testnet.monadexplorer.com/address/0x6d1a5fba0CBbB49878CdF333AA4A7de169bd45A4) |
| **Marketplace (Monad testnet)** | [`0xa99bde0832Db536a39465eB6C412D995bB85dd91`](https://testnet.monadexplorer.com/address/0xa99bde0832Db536a39465eB6C412D995bB85dd91) |

> The live build runs the mock-data UI flow end-to-end (agent creation → task submission → timeline → receipts → rating). Contracts are deployed on Monad testnet — full address + ABI manifest at [`contracts/deployments/monad-testnet.json`](./contracts/deployments/monad-testnet.json). Wagmi wiring of the live UI to the deployed contracts is the next milestone.
...
| Monad testnet deploy | ✅ Live | `contracts/deployments/monad-testnet.json` — Passport `0x6d1a…45A4`, Marketplace `0xa99b…dd91` |
